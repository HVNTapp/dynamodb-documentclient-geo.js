...
export declare class GeoDataManager {
     ...
     */
    queryRectangle(queryRectangleInput: QueryRectangleInput): Promise<DynamoDB.DocumentClient.ItemList>;
    /**
     * <p>
     ...
     * */
    queryRadius(queryRadiusInput: QueryRadiusInput): Promise<DynamoDB.DocumentClient.ItemList>;
    /**
     * <p>
