...
var DynamoDBManager = /** @class */ (function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            minRange = parseFloat(range.rangeMin.toString(10));
                                            maxRange = parseFloat(range.rangeMax.toString(10));
                                            ...
                                            return [4 /*yield*/, this.config.documentClient.query(__assign(__assign({}, defaults), queryInput)).promise()];
                                        case 1:
                                            queryOutput = _a.sent();
    ...
    DynamoDBManager.prototype.getPoint = function (getPointInput) {
        ...
        getItemInput.Key = (_a = {},
            _a[this.config.hashKeyAttributeName] = parseFloat(hashKey.toString(10)),
    ...
    DynamoDBManager.prototype.batchWritePoints = function (putPointInputs) {
        ...
        putPointInputs.forEach(function (putPointInput) {
            ...
            putRequest.Item[_this.config.hashKeyAttributeName] = parseFloat(hashKey.toString(10));
            putRequest.Item[_this.config.rangeKeyAttributeName] = putPointInput.RangeKeyValue;
            putRequest.Item[_this.config.geohashAttributeName] = parseFloat(geohash.toString(10));
            putRequest.Item[_this.config.geoJsonAttributeName] = JSON.stringify({
    ...
    DynamoDBManager.prototype.deletePoint = function (deletePointInput) {
        ...
        var hashKey = S2Manager_1.S2Manager.generateHashKey(geohash, this.config.hashKeyLength);
        return this.config.documentClient.delete(__assign(__assign({}, deletePointInput.DeleteItemInput), { TableName: this.config.tableName, Key: (_a = {},
                _a[this.config.hashKeyAttributeName] = parseFloat(hashKey.toString(10)),
